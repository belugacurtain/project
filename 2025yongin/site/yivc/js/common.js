...
(function ($) {
    ...
    $(function () {
        ...
        $(document).on('click', '.mobile_search_open', function(){
            if(!($(this).parents('#wrapper').is('.search_open'))){
                $(this).parents('#wrapper').addClass('search_open');
            }
        });
        $(document).on('click', '.mobile_search_close', function(){
            if(($(this).parents('#wrapper').is('.search_open'))){
                $(this).parents('#wrapper').removeClass('search_open');
            }
        });
        // 반응형 검색창 레이어 종료

        // 푸터 퀵메뉴 시작
        $('.footer_quick_item.layer_type button.footer_quick_link').on('click', function(){
            if( !($(this).parent('.layer_type').is('.active')) ){
                $(this).parent('.layer_type').addClass('active');
                $(this).attr('title', '퀵 링크 레이어 닫기');
            }
            else{
                $(this).parent('.layer_type').removeClass('active');
                $(this).attr('title', '퀵 링크 레이어 열기');
            }
        });
        // 푸터 퀵메뉴 종료
